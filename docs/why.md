...
`go-ruby-protobuf/protobuf` reimplements Ruby's `protobuf` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-protobuf/protobuf` directly, with no Ruby runtime;
