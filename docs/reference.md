...
The public API lives at the module root (`github.com/go-ruby-protobuf/protobuf`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `protobuf`, while the surface follows
...
```go
import "github.com/go-ruby-protobuf/protobuf"
```
...
- **[pkg.go.dev/github.com/go-ruby-protobuf/protobuf](https://pkg.go.dev/github.com/go-ruby-protobuf/protobuf)**

The module's [README](https://github.com/go-ruby-protobuf/protobuf#readme) carries worked
